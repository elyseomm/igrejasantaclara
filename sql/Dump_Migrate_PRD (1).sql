...
CREATE TABLE `alunos_ivc` (
  ...
  `mae` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Nome da Mãe',
  `pai` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Nome do Pai',
  `dtnasc` date NOT NULL,
  `dtcad` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `sexo` int NOT NULL DEFAULT '0' COMMENT '0 - Feminino / 1 - Masculino',
  `naturalidade` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Estado Natal',
  ...
  `nr` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `bairro` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `desc_engajamento` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `desc_religiao` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ehartista` int DEFAULT '0' COMMENT '0 - Não / 1 - Sim',
  `desc_arte` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `batismos` (
  ...
  `pai` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `mae` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `padrinho` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `madrinha` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `local` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'Local do batiismo',
...
CREATE TABLE `catequistas` (
  ...
  `telefone` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `contatos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `funcao` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `nome` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `cursosbatismo` (
  `id` int NOT NULL AUTO_INCREMENT,
  `celebrante` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `auxiliar` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `telefone` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `docsbatismo` (
  `id` int NOT NULL AUTO_INCREMENT,
  `documento` varchar(800) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT 'Documentos para o batismo',
...
CREATE TABLE `docsmatrimonio` (
  `id` int NOT NULL AUTO_INCREMENT,
  `documento` varchar(800) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT 'Nome do documento',
...
CREATE TABLE `matrimonios` (
  ...
  `dtcad` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `noivo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `noiva` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `data` date NOT NULL,
  `hora` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `local` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `nrlivro` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `obs` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
CREATE TABLE `parocos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT 'Nome dos padres',
  `ehvigario` int DEFAULT '0' COMMENT 'Caso seja vigário',
  `telefone` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `dtnasc` date NOT NULL,
  `dtordem` date DEFAULT NULL,
  `cidadeorigem` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `ativo` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
...
CREATE TABLE `paroquia` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'Nome da Igreja',
  `dtcad` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Data de Cadastro',
  `dtfundacao` date DEFAULT NULL,
  `endereco` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `geoloc` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `telefones` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `obs` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `requisitospadrinhosbatismo` (
  `id` int NOT NULL AUTO_INCREMENT,
  `requisito` varchar(800) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL COMMENT 'Requisito/Critério para ser padrinho de batismo',
  `ativo` int NOT NULL DEFAULT '1' COMMENT 'Ativo / Inativo',
  PRIMARY KEY (`id`)
...
CREATE TABLE `turmas_ivc` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `sala` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Dump completed on 2022-12-28  0:09:31
